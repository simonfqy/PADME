CheckFeaturizer = {
    ('davis', 'graphconv'): ['GraphConv', 75],
    ('davis', 'graphconvreg'): ['GraphConv', 75],
    ('davis', 'tf'): ['ECFP', 1024],
    ('davis', 'tf_regression'): ['ECFP', 1024],
    ('davis', 'weave_regression'): ['Weave', 75],
    ('davis', 'weave'): ['Weave', 75],
    ('davis', 'mpnn_regression'): ['Weave', [75, 14]],
    ('davis', 'mpnn'): ['Weave', [75, 14]],
    ('metz', 'graphconv'): ['GraphConv', 75],
    ('metz', 'graphconvreg'): ['GraphConv', 75],
    ('metz', 'tf'): ['ECFP', 1024],
    ('metz', 'tf_regression'): ['ECFP', 1024],
    ('metz', 'weave_regression'): ['Weave', 75],
    ('metz', 'weave'): ['Weave', 75],
    ('metz', 'mpnn_regression'): ['Weave', [75, 14]],
    ('metz', 'mpnn'): ['Weave', [75, 14]],
    ('kiba', 'graphconv'): ['GraphConv', 75],
    ('kiba', 'graphconvreg'): ['GraphConv', 75],
    ('kiba', 'tf'): ['ECFP', 1024],
    ('kiba', 'tf_regression'): ['ECFP', 1024],
    ('kiba', 'weave_regression'): ['Weave', 75],
    ('kiba', 'weave'): ['Weave', 75],
    ('kiba', 'mpnn_regression'): ['Weave', [75, 14]],
    ('kiba', 'mpnn'): ['Weave', [75, 14]],
    ('toxcast', 'graphconv'): ['GraphConv', 75],
    ('toxcast', 'graphconvreg'): ['GraphConv', 75],
    ('toxcast', 'tf'): ['ECFP', 1024],
    ('toxcast', 'tf_regression'): ['ECFP', 1024],
    ('toxcast', 'weave_regression'): ['Weave', 75],
    ('toxcast', 'weave'): ['Weave', 75],
    ('toxcast', 'mpnn_regression'): ['Weave', [75, 14]],
    ('toxcast', 'mpnn'): ['Weave', [75, 14]],
    ('all_kinase', 'graphconv'): ['GraphConv', 75],
    ('all_kinase', 'graphconvreg'): ['GraphConv', 75],
    ('all_kinase', 'tf'): ['ECFP', 1024],
    ('all_kinase', 'tf_regression'): ['ECFP', 1024],
    ('all_kinase', 'weave_regression'): ['Weave', 75],
    ('all_kinase', 'weave'): ['Weave', 75],
    ('all_kinase', 'mpnn_regression'): ['Weave', [75, 14]],
    ('all_kinase', 'mpnn'): ['Weave', [75, 14]],
    ('tc_kinase', 'graphconv'): ['GraphConv', 75],
    ('tc_kinase', 'graphconvreg'): ['GraphConv', 75],
    ('tc_kinase', 'tf'): ['ECFP', 1024],
    ('tc_kinase', 'tf_regression'): ['ECFP', 1024],
    ('tc_kinase', 'weave_regression'): ['Weave', 75],
    ('tc_kinase', 'weave'): ['Weave', 75],
    ('tc_kinase', 'mpnn_regression'): ['Weave', [75, 14]],
    ('tc_kinase', 'mpnn'): ['Weave', [75, 14]],
    ('tc_full_kinase', 'graphconv'): ['GraphConv', 75],
    ('tc_full_kinase', 'graphconvreg'): ['GraphConv', 75],
    ('tc_full_kinase', 'tf'): ['ECFP', 1024],
    ('tc_full_kinase', 'tf_regression'): ['ECFP', 1024],
    ('tc_full_kinase', 'weave_regression'): ['Weave', 75],
    ('tc_full_kinase', 'weave'): ['Weave', 75],
    ('tc_full_kinase', 'mpnn_regression'): ['Weave', [75, 14]],
    ('tc_full_kinase', 'mpnn'): ['Weave', [75, 14]],
    ('nci60', 'graphconv'): ['GraphConv', 75],
    ('nci60', 'graphconvreg'): ['GraphConv', 75],
    ('nci60', 'tf'): ['ECFP', 1024],
    ('nci60', 'tf_regression'): ['ECFP', 1024],
    ('nci60', 'weave_regression'): ['Weave', 75],
    ('nci60', 'weave'): ['Weave', 75],
    ('nci60', 'mpnn_regression'): ['Weave', [75, 14]],
    ('nci60', 'mpnn'): ['Weave', [75, 14]],
...
CheckSplit = {
    ...
    'metz': ['random', 'index'],
    'kiba': ['random', 'index'],
    'toxcast': ['random', 'index'],
    'all_kinase': ['random', 'index'],
    'tc_kinase': ['random', 'index'],
    'tc_full_kinase': ['random', 'index'],
    'nci60': ['random', 'index'],
